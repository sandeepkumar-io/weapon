      ...
      <div className="relative pt-20 pb-16 px-4 md:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-xl text-blue-300 text-center mb-8">
            Advanced aerial combat aircraft database
          </p>
          ...
          <div className="text-center mb-8">
            <p className="text-gray-400">
              ...
              <span className="text-blue-400 font-semibold">{data.length}</span> fighter jets
            </p>
          </div>
        </div>
      </div>
      ...
      {loading && (
        <div className="flex items-center justify-center min-h-96">
          <div className="text-center">
            ...
            <p className="text-white mt-4">Loading fighter jets...</p>
          </div>
        </div>
      )}
      ...
      {!loading && (
        <div className="max-w-7xl mx-auto px-4 md:px-8 pb-20">
          {filteredData.length > 0 ? (
            ...
            <div className="flex items-center justify-center min-h-96">
              <div className="text-center">
                <p className="text-gray-400 text-lg">No fighter jets found</p>
              </div>
            </div>
          )}
        </div>
